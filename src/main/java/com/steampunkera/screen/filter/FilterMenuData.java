...
public final class FilterMenuData {
    ...
    public record FilterData(BlockPos pos, Direction servoSide, boolean enabled, ServoConfig.FilterMode filterMode, List<Item> filterItems, int mouseX, int mouseY) {
